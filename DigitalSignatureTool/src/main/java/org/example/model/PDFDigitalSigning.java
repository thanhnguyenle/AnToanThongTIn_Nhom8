...
public class PDFDigitalSigning {
    ...
    private String billSignedPath = "hoadonSigned.pdf";
    ...
    public void createKeyStoreFile(String password){
        KeyStore ks = null;
        try {
    ...
    public boolean signBill(String billPath, String keyStorePassword) {
        try {
    ...
    public void verifyPdfSignedIntegrity() throws IOException, GeneralSecurityException {
...
//        sign.signBill(sign.getBillPath(), "password");
//        sign.createKeyStoreFile("password");
//        sign.loadEntriesToKeyStoreFile(sign.getKeyStorePath(), "password", "HUU DAO", "VN", "NLU", "HCM", "THU DUC", "+84");
//        sign.changePasswordKeyStoreFile("newKeyStoreFileName.jks", "password", "password");
        try {
            sign.verifyPdfSignedIntegrity();
        } catch (GeneralSecurityException e) {
            e.printStackTrace();
        } catch (IOException e) {
